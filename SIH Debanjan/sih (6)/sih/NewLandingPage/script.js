...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (loginBtn) {
        loginBtn.addEventListener('click', async () => {
            // Try to redirect to React app login page
            const reactAppUrl = 'http://localhost:5173/login';
            ...
            try {
                ...
                // If React app is not running, show helpful message
                alert('Please start the React application first!\n\nRun: npm run dev\n\nThen the app will be available at http://localhost:5173');
                console.log('React app not running. Please start it with: npm run dev');
            }
        });
    }
...
console.log('Reportly landing page loaded successfully! 🚀');